...
function RegexMaker() {
    ...
    function etlCarrierLookUp(since, done) {
        ...
        var query = `SELECT TOP (${100}) * FROM [Users]..[MobileNumberCarrierLookup] WHERE ModifiedDateTime > '${since}' AND MNC IS NOT NULL AND MCC IS NOT NULL ORDER BY ModifiedDateTime ASC;`;
