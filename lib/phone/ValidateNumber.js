...
function ValidateNumber() {
    ...
    self.transferToNumberLookUp = function (mobilenumber, callback) {
        ...
        console.log("transferToNumberLookUp..", mobilenumber);
        ...
        chunks.forEach((chunk, i) => {
            ...
            (function processNext() {
                ...
                if (!c) {
                    ...
                    self.transferToNumberLookUp(c.numbers, response => {
    ...
    self.check = function (csvFile, processNext) {
        ...
        self.numberLookUps.retryApply(this, contacts.isReady, 100, 1000, [
